...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <AutomationRunner />
      <div className="flex h-screen bg-[#0B0D13] text-zinc-100 overflow-hidden relative selection:bg-blue-500/30">
        <a
          href="#main-content"
        ...
        <main
          id="main-content"
          className="flex-1 overflow-y-auto relative bg-[#0B0D13] focus:outline-none"
          tabIndex={-1}
        >
