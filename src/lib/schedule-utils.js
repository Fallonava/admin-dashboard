...
exports.isShiftActiveForDate = isShiftActiveForDate;
exports.getRoutineLabel = getRoutineLabel;
/**
 ...
 */
function isShiftActiveForDate(extra, date) {
    ...
    if (extra === 'odd_weeks' && weekOfMonth % 2 === 0)
        return false;
    // even_weeks = minggu genap (2, 4) → sembunyikan di minggu ganjil
    if (extra === 'even_weeks' && weekOfMonth % 2 !== 0)
        return false;
    return true;
}
/**
 ...
 */
function getRoutineLabel(extra) {
    if (extra === 'odd_weeks')
