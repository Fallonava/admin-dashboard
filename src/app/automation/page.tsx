        ...
        <div className="relative flex h-full flex-col rounded-3xl bg-slate-50 w-full overflow-hidden shadow-sm border border-slate-200/60">
            ...
            <header className="relative z-10 flex items-center justify-between px-8 pt-8 pb-4">
                ...
                <div className="flex items-center gap-4">
                    <Link href="/automation/rules" className="px-4 py-2 bg-blue-600 text-white rounded-xl shadow hover:bg-blue-500 transition">
                        Rules
                    </Link>
                    <Link href="/automation/logs" className="px-4 py-2 bg-slate-200 text-slate-800 rounded-xl shadow hover:bg-slate-300 transition">
                        Logs
                    </Link>
